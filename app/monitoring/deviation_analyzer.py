    ...
    def _check_operating_mode_limits(
        ...
        for parameter_code, limit in operating_mode_profile.limits.items():
            ...
            return DeviationResult(
                ...
                recommendation=(
                    "Проверить выбранный технологический режим, уставки и "
                    "стабильность подачи сырья/водорода. Если установка уже в "
                    "аварии, смена режима не снимает аварию: нужно выполнить "
                    "аварийные действия и сбросить аварийное состояние после "
